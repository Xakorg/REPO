...
const GAME_MAP: Record<string, React.ComponentType<any>> = {
  titan: dynamic(() => import("@/components/game/titan")),
  ...
  surge: dynamic(() => import("@/components/game/surge")),
  orbit: dynamic(() => import("@/components/game/orbit")),
  vapor: dynamic(() => import("@/components/game/vapor")),
  matrix: dynamic(() => import("@/components/game/matrix")),
  ...
  astral_valkyrie_cyber_overdrive: dynamic(() => import("@/components/game/astral-valkyrie-cyber-overdrive")),
  "astral-valkyrie-cyber-overdrive": dynamic(() => import("@/components/game/astral-valkyrie-cyber-overdrive")),
  chronos_sentinel_quantum_siege: dynamic(() => import("@/components/game/chronos-sentinel-quantum-siege")),
  "chronos-sentinel-quantum-siege": dynamic(() => import("@/components/game/chronos-sentinel-quantum-siege")),
  void_valkyrie_horizon_overdrive: dynamic(() => import("@/components/game/void-valkyrie-horizon-overdrive")),
  "void-valkyrie-horizon-overdrive": dynamic(() => import("@/components/game/void-valkyrie-horizon-overdrive")),
  neon_ronin_cyber_slash: dynamic(() => import("@/components/game/neon-ronin-cyber-slash")),
  "neon-ronin-cyber-slash": dynamic(() => import("@/components/game/neon-ronin-cyber-slash")),
