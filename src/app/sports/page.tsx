...
const TOP_TEAMS = ['PSG', 'Real Madrid', 'Barcelona', 'Manchester', 'Arsenal', 'Bayern', 'Liverpool', 'Chelsea', 'Juventus', 'Milan', 'Portugal', 'Argentina', 'France', 'England', 'Brazil', 'Inter'];
  ...
  useEffect(() => {
    const fetchMatches = async () => {
      try {
        ...
        // Sort to put top teams first, then by date
        const sortedMatches = mappedMatches.sort((a, b) => {
           const aHasTop = TOP_TEAMS.some(t => a.title.includes(t));
           const bHasTop = TOP_TEAMS.some(t => b.title.includes(t));
