  ...
  if (error || !appDetails) {
    return (
      <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center space-y-6">
        ...
        <Link href="/" className="mt-8 bg-white/10 hover:bg-white/20 px-6 py-3 rounded-full font-black uppercase tracking-widest text-xs transition-colors flex items-center justify-center">
          Return to Store
        </Link>
      </div>
    );
  ...
  return (
    <div className="pb-32 bg-black min-h-screen text-white font-sans selection:bg-purple-500/30">
      ...
      <nav className="sticky top-0 z-50 bg-black/50 backdrop-blur-3xl border-b border-white/5 h-20 flex items-center px-8">
        <Link href="/" className="flex items-center gap-2 text-zinc-400 hover:text-white transition-colors font-bold uppercase tracking-wider text-xs">
