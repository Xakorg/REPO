import type { PrepareStepFunction, StepResult, ToolSet, TypedToolCall } from "ai";
 ...
 */
export type HarnessStepResult = Pick<StepResult<ToolSet>, "content" | "finishReason" | "response" | "text" | "toolCalls" | "toolResults" | "usage">;
/**
