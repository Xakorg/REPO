      ...
      <div className="space-y-6">
        ...
        <Card className="p-8 bg-zinc-950/45 border-4 border-white/10 rounded-[3rem] shadow-xl flex items-center gap-6">
          ...
          <div>
            ...
            <div className="text-[9px] font-black uppercase text-zinc-500 tracking-wider mt-1">Instructor</div>
          </div>
        </Card>
      </div>
        ...
        <div className="space-y-3">
          ...
          {students.length === 0 && (
            <div className="py-20 text-center opacity-20 border border-dashed border-white/5 rounded-3xl space-y-4">
              ...
              <p className="text-xs font-black uppercase tracking-widest text-zinc-500">No students registered.</p>
            </div>
          )}
        </div>
      </div>
